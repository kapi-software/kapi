-- ============================================================
-- 002_defaults.sql  Kapi 默认设置种子（对应 docs/DATABASE.md §4）
-- Kapi default settings seed (docs/DATABASE.md §4)
...
INSERT OR IGNORE INTO settings (key, value) VALUES
    ...
    -- Dock (unified in the settings table with the dock_ prefix)
    ('dock_enabled',          'true'),
